...
<div class="flex flex-col md:flex-row justify-between items-start gap-6 border-b border-black/10 dark:border-white/30 pb-6 mb-8 not-prose">
  
  <div class="text-black dark:text-white">
    <h1 class="text-2xl md:text-3xl font-bold mb-2 m-0">Cristóbal Javier Soto Escobar</h1>
    <p class="text-lg font-semibold opacity-80 mb-4 m-0">Civil Engineer specialized in Water Resources</p>
    <div class="space-y-1 text-sm md:text-base">
      <p class="m-0">📍 Temuco, Chile</p>
      <p class="m-0">📧 <a href="mailto:cristobal.soto.9@gmail.com" class="hover:underline opacity-80 hover:opacity-100">cristobal.soto.9@gmail.com</a></p>
      <p class="m-0">🌐 <a href="https://www.cristobalsoto.cl" target="_blank" class="hover:underline opacity-80 hover:opacity-100">www.cristobalsoto.cl</a></p>
    </div>
  </div>

  <div class="flex flex-col items-start md:items-end mt-2 md:mt-0">
    <a href="/doc/2025_CV_Cristobal_Soto_EN.pdf" class="inline-block bg-black dark:bg-white text-white dark:text-black px-4 py-2 rounded font-semibold hover:opacity-80 transition-opacity no-underline" download>
      📄 Download CV (PDF)
    </a>
    <p class="text-xs md:text-sm text-gray-500 mt-2 m-0">
...
- Involved in hydrological and hydraulic projects with a focus on the water cycle and integrated resource management.
...
###### **2016 – 2017** — Analyst, Southern Andes Volcanological Observatory (SERNAGEOMIN)
